...
0xFn - широковещательный пакет - группе n n = 1..E макс 15 групп
0x1n - устройства линии A. n = 0 - блок концентратор. n = 1..E - индивидуальные
0x1n - устройства линии B. n = 0 - блок концентратор. n = 1..E - индивидуальные
0x1n - устройства секундомеры. n = n = 1..E - индивидуальные

   Комманды. Старшие 4 бита - длина данных. Макс 15 байт
Команды без данных
0x00 - Ping - ждем Pong
